-- PURPOSE: THIS FILE IS USED TO GENERATE THE TABLES AND SAMPLE DATA FOR CS 340 GROUP 33's PORTFOLIO PROJECT

-- TURN OFF COMMITS AND FOREIGN KEY CHECKS
...
-- TURN ON COMMIT AND FOREIGN KEY CHECKS
